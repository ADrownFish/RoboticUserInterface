...
QFlowLayout::QFlowLayout(QWidget *parent, int margin, int hSpacing,
                         int vSpacing)
...
void QFlowLayout::addItem(QLayoutItem *item) { itemList.append(item); }
...
int QFlowLayout::count() const { return itemList.size(); }
...
Qt::Orientations QFlowLayout::expandingDirections() const { return Qt::Horizontal; }

bool QFlowLayout::hasHeightForWidth() const { return true; }
...
QSize QFlowLayout::sizeHint() const { return minimumSize(); }
...
void QFlowLayout::setHorizontalSpacing(int hSpacing) { m_hSpace = hSpacing; }

void QFlowLayout::setVerticalSpacing(int vSpacing) { m_vSpace = vSpacing; }

void QFlowLayout::refreshLayout() { doLayout(this->geometry(), false); }
