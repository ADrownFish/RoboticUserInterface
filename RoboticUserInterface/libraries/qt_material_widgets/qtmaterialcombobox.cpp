...
void QtMaterialComboBoxPrivate::init()
{
    ...
    menu         = new QWidget;
    frame        = new QWidget;
    stateMachine = new QtMaterialComboBoxStateMachine(menu);
...
QtMaterialComboBox::QtMaterialComboBox(QWidget *parent)
    : QtMaterialTextField(*new QtMaterialComboBoxPrivate(this), parent)
{
    d_func()->init();
}
...
void QtMaterialComboBox::setDataSource(const QStringList &data)
{
...
void QtMaterialComboBox::updateResults(QString text)
{
    Q_D(QtMaterialComboBox);
...
bool QtMaterialComboBox::QtMaterialComboBox::event(QEvent *event)
{
    Q_D(QtMaterialComboBox);
...
bool QtMaterialComboBox::eventFilter(QObject *watched, QEvent *event)
{
    Q_D(QtMaterialComboBox);
